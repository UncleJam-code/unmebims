...
// Check if ID is provided in the URL and is a valid number
if (!isset($_GET['item_id']) || !filter_var($_GET['item_id'], FILTER_VALIDATE_INT)) {
    die("Invalid request.");
}

$item_id = intval($_GET['item_id']); // Fixed variable name here
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    $item_id = trim(htmlspecialchars($_POST['item_id']));
